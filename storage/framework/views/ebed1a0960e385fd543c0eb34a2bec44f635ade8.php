    <!-- Footer -->
    <footer class="bg-light text-center text-lg-left pt-5 mt-5  d-flex"  id="footer-bg">
        <!-- Grid container -->
            ...
            <div class=" navbar navbar-expand-lg navbar-dark col-lg-3 col-md-6 mb-4 mb-md-0 shadow-0">   
              <ul class="list-unstyled mb-0 navbar-nav flex-row">
                <li class=" nav-item">
                  ...
                  <a href="#!" class="nav-link"> <i class="bi bi-facebook text-white fs-4"></i></a>
                </li>
                <li class="nav-item">
                  <a href="#!" class="nav-link"> <i class="bi bi-github text-white fs-4"></i></a>
                </li>
                <li class="nav-item">
      ...
      <!-- Footer --><?php /**PATH C:\Users\micro-hack\Documents\workspace\dynamic\framworks\laravel\apps\laravel-content-management\resources\views/includes/footer.blade.php ENDPATH**/ ?>